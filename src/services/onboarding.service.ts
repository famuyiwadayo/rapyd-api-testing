...
export default class OnboardingService {
  ...
  async createBiodata(accountId: string, input: BiodataDto, roles: string[]): Promise<Onboarding> {
    ...
    // if (!isMatch(input.personalInfo.dob as string, "yyyy/dd/MM") || !isMatch(input.nextOfKin.dob as string, "yyyy/dd/MM"))
    //   throw createError("Date of birth should have the format: yyyy/dd/MM");
